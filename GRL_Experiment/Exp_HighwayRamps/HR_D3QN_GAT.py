...
class Experiment:
    ...
    def run(self, num_HVs, num_AVs, training, testing, Graph):
        ...
        if Graph:
            from GRL_Net.Model_Discrete.Q_Dueling_GAT import Graph_Model
            GRL_Net = Graph_Model(N, F, A)
        else:
            from GRL_Net.Model_Discrete.Q_Dueling_GAT import NonGraph_Model
        ...
        explorer = explorer_discrete.LinearDecayEpsilonGreedy(start_epsilon=0.3, end_epsilon=0.1, decay_step=20000)
        ...
        GRL_DQN = DoubleDQN_agent.DoubleDQN(
            ...
            model_name="GAT-D3QN_model"  # model name
        )

        # Training
        n_episodes = 15
        max_episode_len = 2500
        save_dir = 'GRL_TrainedModels/GAT'
